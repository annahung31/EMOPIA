...
if __name__ == '__main__':
    ...
    # split train/test
    validation_songs = json.load(open('../validation_songs_2.json', 'r'))
    train_idx = []
    test_idx = []
    ...
    # save train
    path_train = os.path.join(path_root, 'train_data_2_{}'.format(COMPILE_TARGET))
    path_train += '.npz'
    np.savez(
        path_train, 
        x=x_final[train_idx],
    ...
    # save test
    path_test = os.path.join(path_root, 'test_data_2_{}'.format(COMPILE_TARGET))
    path_test += '.npz'
