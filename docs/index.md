...
<table class="num-table" style="width:100%" cellspacing="0" cellpadding="0">
  <tr>
    <th>Quadrant</th>
    <th># clips</th>
...
<figcaption><strong>Table 2.</strong>The number of clips and their average length for each quadrant in Russell’s 4Q, in EMOPIA.</figcaption>
